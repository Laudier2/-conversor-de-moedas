...
export default function Converso(cov) {
  ...
  return (
    <div className="container col-md-6">
      ...
      <br />
      <h5><Marquee gradientColor gradientWidth className="text-dark"><div className="ml-5"></div> Ethereum/Real Brasileiro Atualizado a cada 30 segundos</Marquee> </h5>
        ...
        <div className="form-row">
          <div className="form-group col-md-6 text-primary h1">
            <label className="inputEmail">
              <img src="https://thumbs.dreamstime.com/b/s%C3%ADmbolo-de-ethereum-na-bandeira-futurista-do-hud-106345513.jpg" alt="img" className="img mt-2" />
            </label>
          ...
          <div className="form-group col-md-6 text-primary h1">
            ...
            <div className="form-group input-group">
              ...
              <MaskNumber
                ...
                placeholder="0,00"
                className="form-control h1-m mrg col-md-8"
                value={values > 0 ? eth * values : values}
              />
            </div>
          </div>
        </div>
