...
export default function Converso() {
  ...
  return (
    <div className="container col-md-6">
      ...
      <br />
      <h5><Marquee gradientColor gradientWidth className="text-dark"><div className="ml-5"></div> Novo Shekel Israelense/Real Brasileiro Atualizado a cada 30 segundos</Marquee> </h5>
        ...
        <div className="form-row">
          <div className="form-group col-md-6 text-primary h1">
            <label className="inputEmail">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Flag_of_Israel.svg/234px-Flag_of_Israel.svg.png" alt="img" className="img" />
            </label>
          ...
          <div className="form-group col-md-6 text-primary h1">
            ...
            <div className="form-group input-group">
              ...
              <MaskNumber
                ...
                placeholder="0,00"
                className="form-control h1-m mrg col-md-8"
                value={values > 0 ? ils * values : values}
              />
            </div>
          </div>
        </div>
