...
export default function Converso(cov) {
  ...
  return (
    <div className="container col-md-6">
      ...
      <br />
      <h5><Marquee gradientColor gradientWidth className="text-dark"><div className="ml-5"></div> <div className="ml-5"></div> Euro/Real Brasileiro Atualizado a cada 30 segundos</Marquee> </h5>
        ...
        <div className="form-row">
          <div className="form-group col-md-6 text-primary h1">
            <label className="inputEmail">
              <img src="https://cdn.pixabay.com/photo/2019/10/30/12/45/europe-4589473_960_720.jpg" alt="img" className="img" />
            </label>
          ...
          <div className="form-group col-md-6 text-primary h6">
            <label className="inputEmail">
            ...
            <div className="form-group input-group">
              ...
              <MaskNumber
                ...
                placeholder="0,00"
                className="form-control h1-m mrg col-md-8"
                value={values > 0 ? euro * values : values}
              />
            </div>
          </div>
        </div>
