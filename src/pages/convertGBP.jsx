...
export default function Converso() {
  ...
  return (
    <div className="container col-md-6">
      ...
      <br />
      <h5><Marquee gradientColor gradientWidth className="text-dark"><div className="ml-5"></div> Libra Esterlina/Real Brasileiro Atualizado a cada 30 segundos</Marquee> </h5>
        ...
        <div className="form-row">
          <div className="form-group col-md-6 text-primary h1">
            <label className="inputEmail">
              <img src="
              https://st3.depositphotos.com/13187256/18925/v/1600/depositphotos_189250904-stock-illustration-pound-sterling-symbol-on-background.jpg" alt="img" className="img3" />
            </label>
          ...
          <div className="form-group col-md-6 text-primary h1">
            ...
            <div className="form-group input-group">
              ...
              <MaskNumber
                ...
                placeholder="0,00"
                className="form-control h1-m mrg col-md-8"
                value={values > 0 ? gbp * values : values}
              />
            </div>
          </div>
        </div>
