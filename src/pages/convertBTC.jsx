      ...
      <form>
        <div className="form-row">
          <div className="form-group col-md-6 text-primary h1">
            <label className="inputEmail"><img src="https://static.news.bitcoin.com/wp-content/uploads/2025/01/6595-bitcoin-mined-by-core-scientific-in-2024.jpg" alt="img" className="img mt-1" /></label>
